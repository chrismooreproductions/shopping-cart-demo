...
import { BasketContext, IBasketContext } from '../context/basket/BasketProvider';
...
const renderRemoveProductButton = (basket: IBasketContext, product: IProduct) => {
  if (basket.products.includes(product)) {
    return <button className="btn btn-primary ml-2" name={product.name} onClick={(e) => basket.removeProductFromBasket(e)}>-</button>
  }
}
        ...
        <div className="col-md-6 mb-4">
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">{currency.symbol} {exchangeRatePrice(props.product.price, currency.state.currencies.rates[currency.state.selectedCurrency])} per {props.product.package}</p>
              <button className="btn btn-primary" name={props.product.name} onClick={(e) => basket.addProductToBasket(e)}>+</button>
